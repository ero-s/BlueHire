...
// --- 3. Sub-Components (Stats, Charts, Table Parts) ---
...
// ===========================================================================
// *** STABLE JobDistributionChart Component (CSS Conic-Gradient + Legend Below) ***
// ===========================================================================
const JobDistributionChart: React.FC = () => {
    ...
    return (
      ...
      <div className="bg-white p-4 rounded-lg shadow-sm h-64 flex flex-col justify-between">

        {/* MODIFIED: Added px-2 to ensure the title is not flush with the left edge,
           and used text-left to override any centering effect from the outer container. */}
        ...
        {/* Adjusted grid to align content better horizontally */}
