...
import '../assets/css/Earnings&Reports.css';
import Navbar from '../components/BlueHireNavBar';
import calendarIcon from '../assets/svg/calendar.svg';
import EarningsBarChart from '../components/Earnings&ReportBarChart';
import DonutChart from '../components/Earnings&ReportDonutChart';
import Footer from '../components/Earnings&ReportFooter';
const earningsData = [ 
    { 
