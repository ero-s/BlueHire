...
import { Bell, Mail, Search, ChevronDown, User, LogOut, X, ChevronRight, Clock } from "lucide-react";
...
const AdminHeader: React.FC<HeaderProps> = ({ userName }) => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 w-full px-4 pt-4 pb-0 flex flex-col items-center justify-between gap-4 bg-[#F6F6F6] z-50">
        ...
        <div className="flex items-center gap-3 ml-auto relative">
          ...
          <div className="relative">
            ...
            >
              ...
              {/* MODIFIED: Display UserName and 'Admin' Role */}
              <div className="hidden sm:flex flex-col items-start text-left">
                <span className="text-sm font-semibold text-gray-800 leading-none">{userName}</span>
                <span className="text-[10px] font-medium text-[#4D7EAF] mt-0.5">Admin</span>
              </div>
      ...
      {/* Removed Mobile Navigation Dropdown */}
