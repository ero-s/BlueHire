...
const ClientProfilePage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] font-sans text-gray-800 flex flex-col">
      ...
      <main className="flex-grow w-full max-w-7xl mx-auto mt-24 px-4 md:px-12 py-8 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-8">
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8 h-fit text-center relative border border-gray-100">
            <div className="relative w-32 h-32 mx-auto mb-6">
              ...
              />
              <button className="absolute bottom-0 right-0 bg-blue-500 text-white p-2 rounded-full shadow-md hover:bg-blue-600 transition-colors flex items-center justify-center" aria-label="Edit avatar">
                <Camera size={18} />
              </button>
            </div>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-8 border border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label htmlFor="companyName" className="text-xs font-semibold text-gray-500 uppercase">Company Name</label>
                  <input
                    type="text"
                    id="companyName"
                ...
                <div className="space-y-2">
                  <label htmlFor="role" className="text-xs font-semibold text-gray-500 uppercase">Role</label>
                  <input 
                    type="text" 
                    id="role" 
                    placeholder="e.g. CEO" 
