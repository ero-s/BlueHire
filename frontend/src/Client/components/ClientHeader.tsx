...
import { useNavigate, useLocation, Link } from "react-router-dom"; // 1. Import Router Hooks
...
// 2. Updated Paths (Assuming a /client prefix structure similar to /worker)
  ...
  return (
    <div className="fixed top-0 left-0 right-0 w-full px-4 pt-4 pb-0 flex flex-col items-center justify-between gap-4 bg-[#F6F6F6] z-50">
      <div className="w-full px-4 md:px-12 pt-2 pb-2 flex items-center justify-between gap-4 bg-transparent">
        ...
        {/* 4. Desktop Navigation with Active State Logic */}
        ...
        <div className="flex items-center gap-3 ml-auto md:ml-0 relative">
          ...
          {/* 6. User Menu Dropdown with Navigation */}
      ...
      {/* --- 7. Mobile Navigation Dropdown with Active State --- */}
      {isMobileMenuOpen && (
